...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['action']) && $_POST['action'] == 'tambah_renop') {
        ...
        if (empty($message)) {
            ...
            if ($stmt->execute()) {
                header("Location: admin_kelola_renop.php?status=tambah_sukses");
                exit;
            } else {
    ...
    elseif (isset($_POST['action']) && $_POST['action'] == 'edit_renop') {
        ...
        if (empty($message)) {
            ...
            if ($stmt->execute()) {
                header("Location: admin_kelola_renop.php?status=edit_sukses");
                exit;
            } else {
                $message = "Database Error: " . $stmt->error;
                $message_type = 'error';
    ...
    elseif (isset($_POST['action']) && $_POST['action'] == 'hapus_renop') {
        ...
        header("Location: admin_kelola_renop.php?status=hapus_sukses");
        exit;
    }
}
