            ...
            if (empty($message)) {
                try {
                    ...
                    if ($stmt->execute()) {
                        ...
                        header("Location: kelola_kalender?status=" . $redirect_status);
                        exit;
                    } else {
    ...
    elseif ($action === 'hapus_kalender' && $kalender_id > 0) {
        try {
            ...
            if ($stmt->execute()) {
                ...
                header("Location: kelola_kalender?status=hapus_sukses");
                exit;
            } else {
    ...
    <div class="modal-content">
        ...
        <form id="kalenderForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" onclick="modalHide('kalenderModal')">Batal</button>
