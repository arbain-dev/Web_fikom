...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_POST['action'] == 'tambah_renstra') {
        ...
        if (empty($message)) {
            ...
            if ($stmt->execute()) {
                header("Location: kelola_renstra?status=tambah_sukses");
                exit;
            } else {
    ...
    if ($_POST['action'] == 'edit_renstra') {
        ...
        if (empty($message)) {
            ...
            if ($stmt->execute()) {
                header("Location: kelola_renstra?status=edit_sukses");
                exit;
            } else {
    ...
    if ($_POST['action'] == 'hapus_renstra') {
        ...
        header("Location: kelola_renstra?status=hapus_sukses");
        exit;
    }
}
