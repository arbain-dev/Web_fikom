    ...
    <div class="container reveal-on-scroll">
        ...
        <div class="cta-section fade-in-up delay-5" style="margin-top: 80px; text-align: center; background: white; padding: 60px; border-radius: var(--radius-2xl); border: 1px solid var(--gray-200);">
            <div style="max-width: 600px; margin: 0 auto;">
                <div style="width: 80px; height: 80px; background: var(--primary-100); color: var(--primary-600); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: var(--text-4xl); margin: 0 auto 24px;">
                    <i class="fas fa-clipboard-list"></i>
                </div>
                <h2 style="font-size: var(--text-4xl); font-weight: 700; color: var(--gray-900); margin-bottom: 16px;">
                    Anda Alumni FIKOM?
                </h2>
                <p style="font-size: var(--text-lg); color: var(--gray-600); margin-bottom: 32px; line-height: 1.6;">
                ...
                <a href="https://tracerstudy.kemdikbud.go.id/kuesioner" target="_blank" class="btn btn-primary btn-lg" style="padding: 16px 48px; font-size: var(--text-lg); border-radius: 50px; box-shadow: 0 10px 20px rgba(79, 70, 229, 0.2);">
                    <i class="fas fa-pen-to-square" style="margin-right: 8px;"></i> Isi Form Tracer Study
                </a>
                <p style="margin-top: 16px; font-size: var(--text-sm); color: var(--gray-500);">
